...
def run_tesseract(file_name_template, from_page, to_page):
    for i in range(from_page, to_page+1):
        ...
        os.system(f"tesseract {file_name} stdout -l yid > {page}.txt")
...
if __name__ == '__main__':
    ...
    print(sys.argv)
    run_tesseract(sys.argv[1], int(sys.argv[2]), int(sys.argv[3]))
    print(os.getcwd())
